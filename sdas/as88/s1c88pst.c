...
/* end sdas specific */
	...
	/* Epson S1C88 machine instructions (sdcc88 retarget) */

    {	NULL,	"ld",	S_LD,	0,	0	},
    {	NULL,	"add",	S_ADD,	0,	0x00	},
    {	NULL,	"adc",	S_ADC,	0,	0x08	},
    {	NULL,	"sub",	S_SUB,	0,	0x10	},
    {	NULL,	"sbc",	S_SBC,	0,	0x18	},
    {	NULL,	"and",	S_AND,	0,	0x20	},
    {	NULL,	"or",	S_OR,	0,	0x28	},
    {	NULL,	"cp",	S_CP,	0,	0x30	},
    {	NULL,	"xor",	S_XOR,	0,	0x38	},
    {	NULL,	"inc",	S_INC,	0,	0	},
    {	NULL,	"dec",	S_DEC,	0,	0	},
    {	NULL,	"push",	S_PUSH,	0,	0	},
    {	NULL,	"pop",	S_POP,	0,	0	},
    {	NULL,	"ex",	S_EX,	0,	0	},
    {	NULL,	"ret",	S_INH,	0,	0xF8	},
    {	NULL,	"rete",	S_INH,	0,	0xF9	},
    {	NULL,	"rets",	S_INH,	0,	0xFA	},
    {	NULL,	"jp",	S_JP,	0,	0xF4	},
    {	NULL,	"call",	S_CALL,	0,	0xFB	},
    {	NULL,	"jrs",	S_JRS,	0,	0xF1	},
    {	NULL,	"jrl",	S_JRL,	0,	0xF3	},
    ...
    {	NULL,	"srl",	S_ROT,	0,	0x8C	},
    {	NULL,	"rl",	S_ROT,	0,	0x90	},
    {	NULL,	"rlc",	S_ROT,	0,	0x94	},
    {	NULL,	"rr",	S_ROT,	0,	0x98	},
    {	NULL,	"rrc",	S_ROT,	0,	0x9C	},
    {	NULL,	"cpl",	S_ROT,	0,	0xA0	},
    {	NULL,	"neg",	S_ROT,	0,	0xA4	},
    {	NULL,	"swap",	S_SWAP,	0,	0xF6	},
    {	NULL,	"mlt",	S_INHE,	0,	0xD8	},
    {	NULL,	"div",	S_INHE,	0,	0xD9	},
    {	NULL,	"sep",	S_INHE,	0,	0xA8	},
    {	NULL,	"halt",	S_INHE,	0,	0xAE	},
